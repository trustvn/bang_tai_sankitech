$(document).ready(function(){
	if($(window).innerWidth()>1025){
		$("html").niceScroll({
            ...
            cursorcolor         : 'rgba(0, 166, 226, 0.5)',
            cursorwidth         : 10,
    ...
    setlazy($("#vnt-slide-home .captionWrap,.navation"), 'fadeInLeft', '0.1'); 
    setlazy($(".news,.project,.solution,.service,.row-cate,.product"), 'fadeIn', 'Math.random()');     
    setlazy($(".vnt-about .section"), 'fadeIn', '0.3');     
    setlazy($(".topContent .des-quote,.boxProduct .caption"), 'fadeInUp', '0.3');     
    setlazy($(".botIntro .img"), 'reveal', '0.3'); 
    setlazy($(".botIntro .caption,.boxProject .caption,.boxAbout .content,.topContent .in,.topIntro .main-intro .info-company,.boxText .grid:nth-child(2n+1) .caption,.proj-list .item:nth-child(2n) .caption"), 'fadeInRight', '0.3');
    setlazy($(".topIntro .main-intro .name-company,.boxText .grid:nth-child(2n) .caption,.proj-list .item:nth-child(2n+1) .caption"), 'fadeInLeft', '0.3');
    setlazy($(".row-cate .tend a,.row-service .rowTitle .number"), 'fadeInDown', '0.1'); 
    setlazy($(".row-cate .content,.row-service .caption"), 'slide', '0.6');
    // BIGIN LAZYLOADING
    var isMobile = false;
    ...
    $(window).on("scroll",function(){
        if($(window).scrollTop()>header_off){
            $("#vnt-header .wrapper").addClass("fixed");
        }
        else{
            $("#vnt-header .wrapper").removeClass("fixed");
        }
    }); 
    ...
    if (ie) {
      $(".news .img,.project .img,.solution .img,.service .img,.product .img,.boxLogo .img").each(function () {
        var $container = $(this),
